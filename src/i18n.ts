...
export const resources: LanguageResources = {
  en: {
    translation: {
      ...
      notMatch: 'Unfortunately, your credentials do not match any organizational account',
      ...
      hasNotAccDescr: "Contact the local service provider's support team for further assistance.",
  ...
  ru: {
    translation: {
      lang: 'Русский',
      notAvailable: 'Сервис недоступен в этой локации. Пожалуйста, выберите другую локацию.',
      ...
      notMatch: 'Ваши учетные данные не соответствуют ни одному организационному аккаунту.',
...
export const currentLang = () => {
  ...
  const currentLang = !language || !locales.includes(language as Langs) ? locales[0] : language;
